...
<template>
  <VerticalNavLink v-if="is(['admin'])" :item="{
    title: 'Dashboard',
    icon: 'bx-home',
    to: '/admin/dashboard',
  }" />
  ...
  <VerticalNavLink v-if="is(['checker'])" :item="{
    title: 'Material Movement',
    icon: 'bx-transfer',
    to: '/checker/material-movement/create',
  }" />

  <VerticalNavLink v-if="is(['gas-operator'])" :item="{
  ...
  <VerticalNavLink v-if="is(['technical-admin'])" :item="{
    title: 'Perpindahan Material',
    icon: 'bx-transfer',
