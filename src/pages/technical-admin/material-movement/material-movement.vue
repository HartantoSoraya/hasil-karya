      ...
      <VCard>
        <VForm>
          <VRow>
            ...
            <VCol cols="12" md="6">
              <VTextField v-model="truck_capacity" label="Kapasitas Truck" placeholder="Kapasitas Truck"
                :error-messages="error && error.truck_capacity ? [error.truck_capacity] : []" type="number" step="1"
                suffix="m³" readonly="" />
            </VCol>

            <VCol cols="12" md="6">
              <VTextField v-model="observation_ratio" label="Rasio Index" placeholder="Rasio Index"
            ...
            <VCol cols="12" md="6">
              <VTextField v-model="solid_ratio" label="Rasio Padat" placeholder="Rasio Padat"
                :error-messages="error && error.solid_ratio ? [error.solid_ratio] : []" type="number" readonly="" />
            </VCol>
